...
const camusSqlKeywords =
  /\b(?:ADD|ALL|ALTER|ANALYZE|ANCESTORS|AND|AS|ASC|BEGIN|BETWEEN|BRANCH|BRANCHES|BY|CACHE|CASE|CAST|CHECK|CLEAR|COLUMN|COLUMNS|COMMENT|COMMIT|COMMITTED|CONSTRAINT|CREATE|DATABASE|DATABASES|DEFAULT|DELETE|DESC|DESCRIBE|DISTINCT|DROP|ELSE|END|EVICT|EXISTS|EXIT|EXPLAIN|FALSE|FORCE|FORCE_INDEX|FROM|GROUP|HAVING|IF|ILIKE|IN|INCLUDE|INDEX|INDEXES|INNER|INSERT|INTO|IS|ISOLATION|JOIN|KEY|LEVEL|LIKE|LIMIT|LOCKING|LOGICAL|NOT|NULL|OF|OFFSET|ON|ONLY|OPTIMISTIC|OR|ORDER|ORPHAN|PESSIMISTIC|PHYSICAL|PRIMARY|QUIT|READ|RELINK|RENAME|ROLLBACK|SELECT|SERIALIZABLE|SET|SHOW|SOURCE|START|STRICT|SYSTEM|TABLE|TABLES|THEN|TIME|TO|TRANSACTION|TRUE|UNIQUE|UPDATE|USE|VALUES|VIEW|VIEWS|WHEN|WHERE|WRITE)\b/i;
