...
const camusSqlKeywords =
  /\b(?:ADD|ALL|ALTER|ANALYZE|ANCESTORS|AND|AS|ASC|BACKGROUND|BEGIN|BETWEEN|BRANCH|BRANCHES|BY|CACHE|CASE|CAST|CHECK|CLEAR|COLUMN|COLUMNS|COMMENT|COMMIT|COMMITTED|CONSTRAINT|CREATE|CRITICAL|DATA|DATABASE|DATABASES|DEFAULT|DELETE|DESC|DESCRIBE|DISTINCT|DROP|ELSE|END|ENGINE|EVICT|EXISTS|EXIT|EXPLAIN|FALSE|FOR|FORCE|FORCE_INDEX|FROM|GRANT|GRANTS|GROUP|HAVING|HIGH|IDENTIFIED|IF|ILIKE|IN|INCLUDE|INDEX|INDEXES|INNER|INSERT|INTO|IS|ISOLATION|JOIN|KEY|LEVEL|LIKE|LIMIT|LOCKING|LOGICAL|LOW|NO|NORMAL|NOT|NULL|OF|OFFSET|ON|ONLY|OPTIMISTIC|OR|ORDER|ORPHAN|PASSWORD|PESSIMISTIC|PHYSICAL|PRIMARY|PRIORITY|PRIVILEGES|QUIT|READ|RELINK|RENAME|RESET|REVOKE|ROLLBACK|SELECT|SERIALIZABLE|SET|SHOW|SOURCE|START|STATS|STRICT|SYSTEM|TABLE|TABLES|THEN|TIME|TO|TRANSACTION|TRUE|TTL|UNIQUE|UPDATE|USE|USER|VALUES|VARIABLES|VIEW|VIEWS|WHEN|WHERE|WITH|WRITE)\b/i;
