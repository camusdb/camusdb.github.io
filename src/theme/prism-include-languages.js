...
const camusSqlKeywords =
  /\b(?:ADD|ALTER|ANALYZE|AND|AS|ASC|BEGIN|BETWEEN|BY|CAST|COLUMN|COLUMNS|COMMIT|COMMITTED|CONSTRAINT|CREATE|DATABASE|DATABASES|DEFAULT|DELETE|DESC|DESCRIBE|DISTINCT|DROP|EXISTS|EXPLAIN|FALSE|FORCE_INDEX|FROM|GROUP|HAVING|IF|ILIKE|IN|INDEX|INDEXES|INNER|INSERT|INTO|IS|ISOLATION|JOIN|KEY|LEVEL|LIKE|LIMIT|LOGICAL|NOT|NULL|OFFSET|ON|ONLY|OR|ORDER|PHYSICAL|PRIMARY|READ|RENAME|ROLLBACK|SELECT|SERIALIZABLE|SET|SHOW|START|TABLE|TABLES|TO|TRANSACTION|TRUE|UNIQUE|UPDATE|VALUES|WHERE|WRITE)\b/i;

const camusSqlTypes =
  /\b(?:ARRAY|BLOB|BOOL|BOOLEAN|BYTES|DATE|DATETIME|DOUBLE|FLOAT32|FLOAT64|INT|INT64|INTEGER|OBJECT_ID|OID|REAL|STRING|TIMESTAMP)\b/i;
